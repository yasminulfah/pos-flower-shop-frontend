...
function HomePage() {
  return (
    <div>
        <Navbar />
        <div className="flex mx-10 justify-between items-center gap-5 lg:gap-20">
            ...
            <div className="flex flex-col gap-10">
                ...
                <h1 className="text-5xl lg:text-7xl font-extrabold text-pink-500">The Ultimate Flower Shopping Destination</h1>
